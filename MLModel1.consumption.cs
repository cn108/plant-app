...
namespace FinalYearProject
{
    public partial class MLModel1
    {
        ...
        private static PredictionEngine<ModelInput, ModelOutput> CreatePredictEngine()
        {
            ...
            // Use relative path to the model file in the output directory
            string MLNetModelPath = Path.Combine(AppContext.BaseDirectory, "MLModel1.mlnet");

            // Check if the model file exists
            if (!File.Exists(MLNetModelPath))
            {
                throw new FileNotFoundException($"ML model file not found: {MLNetModelPath}");
            }
